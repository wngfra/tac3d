...
void _run_L3_spike_thresholder_codeobject()
{
...
const size_t _numv = 36;
    ...
    for(size_t _idx=0; _idx<N; _idx++)
    {
        ...
        const char not_refractory = _ptr_array_L3_not_refractory[_idx];
        ...
        if(_cond) {
            _ptr_array_L3__spikespace[_count++] = _idx;
            _ptr_array_L3_not_refractory[_idx] = false;
            _ptr_array_L3_lastspike[_idx] = _ptr_array_defaultclock_t[0];
        }
    }
    _ptr_array_L3__spikespace[N] = _count;
