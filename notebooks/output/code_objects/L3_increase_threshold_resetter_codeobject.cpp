...
const double delta_theta = 0.005;
const size_t _numv_th = 36;
	...
	const int32_t *_events = _ptr_array_L3__increase_thresholdspace;
	const int32_t _num_events = _ptr_array_L3__increase_thresholdspace[N];
	...
	for(int32_t _index_events=0; _index_events<_num_events; _index_events++)
	{
        ...
        v_th += delta_theta * _rand(_vectorisation_idx);
