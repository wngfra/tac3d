...
void _run_Syn23_post_codeobject()
{
...
const size_t _numcount = _dynamic_array_Syn23_count.size();
    ...
    {
    std::vector<int> *_spiking_synapses = Syn23_post.peek();
        ...
        _spiking_synapse_idx++)
    {
        ...
        double count = _ptr_array_Syn23_count[_idx];
        double X_condition;
        count += 1;
        X_condition = 0;
        _ptr_array_Syn23_X_condition[_idx] = X_condition;
        _ptr_array_Syn23_count[_idx] = count;
...
void _debugmsg_Syn23_post_codeobject()
{
    using namespace brian;
