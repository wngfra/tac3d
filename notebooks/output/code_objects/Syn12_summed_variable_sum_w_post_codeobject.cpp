...
double* const _array_Syn12_w = _dynamic_array_Syn12_w.empty()? 0 : &_dynamic_array_Syn12_w[0];
const size_t _numw = _dynamic_array_Syn12_w.size();
const size_t _num_postsynaptic_idx = _dynamic_array_Syn12__synaptic_post.size();
    ...
    double* __restrict  _ptr_array_Syn12_w = _array_Syn12_w;
    ...
    {
        _ptr_array_L2_sum_w[_target_idx + 0] = 0;
    }
    ...
    for(int _idx=0; _idx<_ptr_array_Syn12_N[0]; _idx++)
    {
        // vector code
        const size_t _vectorisation_idx = _idx;
                
        const double w = _ptr_array_Syn12_w[_idx];
        const double _synaptic_var = w;

        _ptr_array_L2_sum_w[_ptr_array_Syn12__synaptic_post[_idx]] += _synaptic_var;
    }
